---
title: "R-DINA JAGS SimpleQ Analysis"
params:
  dataSet: R_DINA_SimpleQ_Poor.500
  guuid: 2283fe85-9cac-45e4-aab4-7aaba1f215d9
  simulationDirectory: ~/Dropbox/Graduate/Dissertation/DCM Simulation Results/R-DINA/2283fe85-9cac-45e4-aab4-7aaba1f215d9
output:
  html_document:
    toc: yes
  pdf_document:
...
#                      Load the simulation                                   #
##############################################################################
load(paste(params$guuid, "-Sim.RData", sep=''))
